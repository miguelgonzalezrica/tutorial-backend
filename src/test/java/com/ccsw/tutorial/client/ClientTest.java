...
public class ClientTest {
    ...
    public static final String CLIENT_NAME = "Pablo del Val";
    ...
    public void saveNotExistsClientIdShouldInsert() {
        ...
        ArgumentCaptor<Client> category = ArgumentCaptor.forClass(Client.class);

        clientService.save(null, clientDto);

        verify(clientRepository).save(category.capture());

        assertEquals(CLIENT_NAME, category.getValue().getName());
    }
