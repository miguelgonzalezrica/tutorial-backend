...
public class ClientIT {
    ...
    public static final String NEW_CLIENT_NAME = "Pablo González";
    ...
    public void deleteWithExistsIdShouldDeleteClient() {
        ...
        ResponseEntity<List<ClientDto>> response1 = restTemplate.exchange(LOCALHOST + port + SERVICE_PATH, HttpMethod.GET, null, responseType);
        System.out.println(response1.getBody().size());
